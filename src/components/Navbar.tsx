...
//   // ✅ Links definidos en un array para evitar duplicación
//   const links = [
//     { to: "/", label: "Inicio" },
...
//           {links.map(({ to, label }) => (
//             <li key={to}>
//               <NavLink to={to} className={navClasses}>{label}</NavLink>
//             </li>
//           ))}
//         </ul>
//       </div>
...
//             {links.map(({ to, label }) => (
//               <li key={to}>
//                 <NavLink to={to} onClick={toggleMenu} className={navClasses}>
//                   {label}
//                 </NavLink>
//               </li>
//             ))}
...
import { useState } from 'react';
import { Link, NavLink } from 'react-router-dom';
import { links } from '../constants/Links'; // ✅ Enlaces importados desde Links.ts con mayúscula
